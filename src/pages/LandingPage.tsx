...
export default function LandingPage({scrollToSection}: LandingPageProps) {
  ...
  return (
    <div className="relative min-h-screen w-full bg-gradient-to-b from-zinc-950 to-black shadow-custom overflow-hidden">
      <div className="absolute inset-0 flex flex-col md:flex-row items-center justify-center text-slate-50 p-4 md:p-8">
        {!isMobile && (
      ...
      {!isMobile && (
        <div 
          className="absolute bottom-10 left-1/2 transform -translate-x-1/2 animate-bounce cursor-pointer text-slate-50" 
