...
import { useFilteredData, useGroupedData, useSortedSensors } from "../hooks/hooks";
    ...
    <div className="min-h-screen bg-background text-foreground p-4 sm:p-6 md:p-8 space-y-6">
      ...
      <Card className="bg-card border-transparent focus:border-transparent focus:ring-0 shadow-mac">
        <CardHeader>
          ...
          <CardDescription className="text-muted-foreground">Current status and uptime of all sensors</CardDescription>
        </CardHeader>
